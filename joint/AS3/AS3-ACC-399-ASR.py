...
def calculateACC_ATTACK_baseonLLM(file):
    ...
    # print(true_res_mid1)
    # print(true_res_mid2)
    # print(true_res_epoch)
    # print(numofdata)

    if "Attack" in file:
        resfile.writelines(f"######\n\n{file}\n\n")
        resfile.writelines(f"ASR_llm1: {true_res_mid1}/{numofdata}\n")
        resfile.writelines(f"ASR_llm2: {true_res_mid2}/{numofdata}\n")
        resfile.writelines(f"ASR_server: {true_res_epoch}/{numofdata}\n")
    else:
        resfile.writelines(f"######\n\n{file}\n\n")
        resfile.writelines(f"CA_llm1: {true_res_mid1}/{numofdata}\n")
        resfile.writelines(f"CA_llm2: {true_res_mid2}/{numofdata}\n")
        resfile.writelines(f"CA_server: {true_res_epoch}/{numofdata}\n")
    resfile.close()
